...
The query owns initial focus. Selection is always visible, pointer actions never trigger the row action, and every icon button has an accessible name and tooltip. The footer remains compact and treats keyboard guidance as operational metadata.
