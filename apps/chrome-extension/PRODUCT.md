...
Chrome-first. Search open tabs, then activate, close, pin, or mute them. No browser commands, history, bookmarks, native messaging, agents, telemetry, external network requests, persistent host permissions, or static all-page content script.
