...
import { Dialog, Field, Input, Select, Textarea } from "@/components/ui/form-controls";
import { TaskDetails } from "@/features/tasks/task-details";
import { TaskForm, priorities, statuses } from "@/features/tasks/task-form";
...
import { runMutation, useEffectQuery } from "@/lib/effect";
...
function Workspace() {
  ...
  const taskId =
    ...
    !["/tasks/backlog", "/tasks/active", "/tasks/completed"].includes(location.pathname)
      ...
      : undefined;
  const projectId = location.pathname.startsWith("/projects/") ? parameters.projectId : undefined;
          ...
          <div key={project.id} className="group flex items-center">
            <button
              ...
              className={cn(
                ...
                activePath === `/projects/${project.id}` && "bg-accent text-foreground",
              )}
            >
