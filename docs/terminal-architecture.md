...
The Ghostty snapshot and compaction gate is satisfied at revision `07bccf7a311acdfa6afc77f2016160d49b1f1982`. Continuation parity, binary protocol conformance, reactor/descriptor-reuse stress, bounded slow-client resync and the release scale probe remain release gates. Physical 1,000-PTY evidence must come from an operating system configured to admit at least 1,000 PTYs.
